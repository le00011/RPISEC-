...
int main(int argc, char** argv)
{
	if(argc != 3)
		{
			printf("Olá. Este programa fará uma comparação lexicográfica do \
	conteúdo de dois arquivos. Ele possui a funcionalidade extra de ser \
	capaz de processar tanto nomes de arquivos quanto descritores de arquivos.\n");
			printf("Uso: %s {-fn=<nome_do_arquivo>|-fd=<descritor_do_arquivo>} {-fn=<nome_do_arquivo>|-fd=<descritor_do_arquivo>}\n", argv[0]);
			return EXIT_FAILURE;
	}
